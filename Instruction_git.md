...
Чтобы не забыть что изменено (или добавлено, или удалено) в файле, использую короткие сообщения *(желательно на английком языке)*, и команда приобретает следующий вид: 

    git commit -m "message"

Если нет желания писать программу **git add**, то можно пропустить этот этап индексирования, выполнив его автоматически с программой *git commit*, написав программу немного иначе:
