...
После выполнения этой команды, вы продолжите работать на основной ветке (master), а не на ветке с вашим названием < name branch >. Чтобы перехода но новую ветку, читай инструкцию ниже.  

Чтобы в этом убедиться, можно запустить просмотр всех веток (командой выше - *git branch*).
