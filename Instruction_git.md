...
**Обрати внимание:** сливание веток происходит из ветки в которая явояется основной (например, master), поэтому перед сливанием веток обязательно проверь, на какой ветки ты сейчас находишься и, при необходимости, переключись (как - смотри инструкцию выше) на нужную ветку. В качестве < branch name >  в приведенной команде используется имя ветки, которую необхолимо слить с текущей.
