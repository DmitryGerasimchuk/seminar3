...
**Обрати внимание:** используй в названии такие имена, чтобы можно было понять что это за ветка (не используй просто набор символов и пробелы между словами).

Для переключения на новую ветку используй команду:

    git checkout <name branch>

После выполнения этой команды, вы станете работать не на основной ветке (master), а на ветке с вашим названием < name branch >.  

Чтобы в этом убедиться можно запустить просмотр всех веток (командой ниже).
